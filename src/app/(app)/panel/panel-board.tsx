...
import type { Creator } from "~/server/domain/creators";
 ...
 *
 * The lineup is resolved server-side from the ingested roster and passed in, so a newly ingested
 * creator shows up here with no code change.
 */
export function PanelBoard({ creators }: { creators: Creator[] }) {
